                ...
                {['SSC CGL', 'UPSC', 'Banking', 'Railway'].map((exam) => (
                  ...
                  >
                    <div className={`w-10 h-10 rounded-xl mb-4 flex items-center justify-center transition-colors ${
                      data.targetExam === exam ? 'bg-primary-600 text-white' : 'bg-slate-50 text-slate-400 group-hover:bg-slate-100'
                    }`}>
                ...
                {[
                  ...
                  >
                    <div className={`w-12 h-12 rounded-2xl flex items-center justify-center ${
                      data.currentLevel === level.id ? 'bg-primary-600 text-white' : 'bg-slate-50 text-slate-400'
                    }`}>
